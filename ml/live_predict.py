...
def main():
    ...
    dashboard = ISLDashboard(width=1280, height=720)
    window_title = "ISL Sign-to-Speech - Live Recognition"
    ...
    with create_landmarker() as landmarker:
        ...
        while True:
            ...
            # Draw hand skeleton overlay on camera preview
            frame = dashboard.draw_hand_landmarks_on_camera(frame, result)
            ...
            if now_fps - fps_timer >= 0.5:
                fps = fps_counter / (now_fps - fps_timer)
                fps_counter = 0
                fps_timer = now_fps

            # =================================================
            # Determine Stability Progress
            # =================================================

            counts = Counter(prediction_history)
            leader_count = counts.most_common(1)[0][1] if counts else 0
            ...
            dashboard_frame = dashboard.render(
                ...
                stable_count=leader_count,
                stable_count_required=STABLE_COUNT_REQUIRED,
                accumulated_words=builder.get_words(),
                generated_sentence=generated_sentence,
                speech_status=status_text,
